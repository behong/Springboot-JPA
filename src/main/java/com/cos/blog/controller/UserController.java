...
// static 이하에 있는 resource 들.. /js/** , /css/** , /image/**
...
public class UserController {
	...
	public String kakaoCallback(String code) {  //data를 리턴해주는 컨트롤러 함수
		// POST 방식으로 전달 key = value 데이터를 요청 (카카오로)
		// Retrofi2
		// OkHttp
		...
		params.add("client_id", "7450b05d59eca9a9e930badbb1fffaf0");
		...
		//UUID garbagePasswod = UUID.randomUUID();
		// 중복되지 않는 아이디...
		...
		if(orginUser.getUsername() == null) {
			System.out.println("기존 회원이 아닙니다." + orginUser);
